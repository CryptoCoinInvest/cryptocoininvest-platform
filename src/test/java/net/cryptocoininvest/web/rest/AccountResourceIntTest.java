package net.cryptocoininvest.web.rest;

import net.cryptocoininvest.config.Constants;
import net.cryptocoininvest.CryptocoininvestApp;
import net.cryptocoininvest.domain.Authority;
import net.cryptocoininvest.domain.PersistentToken;
import net.cryptocoininvest.domain.User;
import net.cryptocoininvest.repository.AuthorityRepository;
import net.cryptocoininvest.repository.PersistentTokenRepository;
import net.cryptocoininvest.repository.UserRepository;
import net.cryptocoininvest.security.AuthoritiesConstants;
import net.cryptocoininvest.service.MailService;
import net.cryptocoininvest.service.dto.UserDTO;
import net.cryptocoininvest.web.rest.errors.ExceptionTranslator;
import net.cryptocoininvest.web.rest.vm.KeyAndPasswordVM;
import net.cryptocoininvest.web.rest.vm.ManagedUserVM;
import net.cryptocoininvest.service.UserService;
...
@SpringBootTest(classes = CryptocoininvestApp.class)
