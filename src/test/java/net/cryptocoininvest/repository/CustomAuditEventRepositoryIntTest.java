package net.cryptocoininvest.repository;

import net.cryptocoininvest.CryptocoininvestApp;
import net.cryptocoininvest.config.Constants;
import net.cryptocoininvest.config.audit.AuditEventConverter;
import net.cryptocoininvest.domain.PersistentAuditEvent;
...
import static net.cryptocoininvest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
